var BMapLib = window.BMapLib = BMapLib || {}; (function() {
    ...
    var c = BMapLib.LuShu = function(g, f, e, callback) {
        if (!f || f.length < 1) {
            return
        }
        this._map = g;
    ...
    c.prototype.setPos = function(pos) {
        var f = this;
        f.i = pos;
    }
    ...
    a.object.extend(c.prototype, {
        ...
        _move: function(n, j, m) {
            ...
            i._intervalFlag = setInterval(function() {
                // console.log("11:", h, g);
                // console.log(i._path.length, i.i);
                if (h >= g) {
                    // console.log(h, g);
    ...
    d.prototype.initialize = function(e) {
        var f = this._div = a.dom.create("div", {
            style: "border:solid 1px #ccc;width:auto;min-width:50px;text-align:left;position:absolute;background:#fff;color:#000;font-size:12px;border-radius: 10px;padding:15px;white-space: nowrap;"
        });
